(function(){
  ...
  const authHtml = userToken
    ? `<div class="nav-user-area"><span class="nav-user-name">👤 ${esc(userName || '用户')}</span><a href="#" class="nav-auth-btn" onclick="localStorage.removeItem('user_token');localStorage.removeItem('user_name');location.href='/login.html';return false">退出</a></div>`
